...
#ifndef VJDSTAT
#define VJDSTAT
typedef enum _VjdStat  /* Declares an enumeration data type */
{
...
typedef enum _FFBPType // FFB Packet Type
{
	// Write
